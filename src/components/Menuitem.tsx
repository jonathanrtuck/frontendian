...
export const Menuitem: FunctionComponent<MenuitemProps> = ({
  ...
  if ("separator" in props) {
    return (
      <li
        ...
        className={clsx(className, classes?.separator, "menuitem separator")}
        onClick={() => {
  ...
  const getChildMenuitemButtons = (): HTMLElement[] =>
    Array.from(
      rootRef.current?.querySelectorAll(
        `:scope > [role="menu"] > .menuitem > .button`
      ) ?? []
    );
  ...
  return (
    <li
      ...
      className={clsx(className, classes?.menuitem, "menuitem", {
      ...
      <button
        ...
        onKeyDown={(e) => {
          ...
          const parentMenuitemButton =
            parentMenuitem?.querySelector<HTMLElement>("button");
            ...
            case "ArrowLeft":
              if (isTop) {
                ...
                if (
                  ...
                  parentMenuitem?.matches(".menuitem--horizontal")
                ) {
            ...
            case "ArrowRight":
              if (isTop) {
                ...
                if (haspopup) {
                  ...
                  const topMenuitem = topMenuitemButton?.closest(".menuitem");

                  if (
                    topMenuitemButton &&
                    topMenuitem?.matches(".horizontal")
                  ) {
        ...
        tabIndex={tabIndex}
        type="button">
        {!!Icon && <Icon aria-hidden className={clsx(classes?.icon, "icon")} />}
        <span className={clsx(classes?.title, "title")} id={`${id}-title`}>
          {title}
        </span>
      </button>
